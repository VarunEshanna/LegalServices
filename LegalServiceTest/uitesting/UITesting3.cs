...
namespace LegalServiceTest.uitesting
{
    public class UITesting3
    {
        ...
        public void TestContactCreateWithAccountLookUp2(Microsoft.Xrm.Sdk.Entity entity)
        {
            using (var xrmBrowser = new Browser(TestSettings.Options))
            {
                ...
                xrmBrowser.Entity.SetValue("parentcustomerid", "Fourth Coffee");
                xrmBrowser.Entity.SelectLookup("parentcustomerid", 1);
